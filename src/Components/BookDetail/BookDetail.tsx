...
import { Rate, Divider, Button, InputNumber, Pagination } from 'antd';
import { LikeOutlined, HeartOutlined, MessageOutlined, MinusOutlined, PlusOutlined } from "@ant-design/icons";
                ...
                <div className="details-related-section p-5 d-flex gap-5 ">
                    <div className="details-reviews" style={{ width: "70%" }} >
                        <div className="details-reviews-heading d-flex gap-5 align-items-center mb-4">
                            <NavLink style={{ color: "#11142D", fontSize: "30px", textDecoration: "none", fontWeight: "700" }} to="/home/books/detail">Details Product</NavLink>
                            <NavLink style={{ color: "#AAA", fontSize: "30px", textDecoration: "none", fontWeight: "700" }} to="/home/books/review">Customer Reviews</NavLink>
                        </div>
                        <div className="details-product">
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between  align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Book Title</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >Thunder Stunt</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Author</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >Kevin Smile</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >ISBN</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >121341381648 (ISBN13: 121341381648)</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Ediiton Language</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >English</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Book Format</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >Paperback, 450 Pages</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Date Published</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >August 10th 2019</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Publisher</h6>
                                </div>
                                <div className="detailproduct-two w-50" >
                                    <p style={{ color: "#11142D)", fontWeight: "400", lineHeight: "24px", padding: "0", margin: "0" }} >Wepress Inc.</p>
                                </div>
                            </div>
                            <div style={{ border: "1px solid #F0EEFF", borderRadius: "0px 10px 0px 0px" }} className="detailone d-flex justify-content-between align-items-center p-3 ">
                                <div className="detailproduct-one w-50 ">
                                    <h6 style={{ color: "#11142D", fontWeight: "700", lineHeight: "24px", padding: "0", margin: "0", textAlign: "start" }} >Tags</h6>
                                </div>
                                <div className=" details-tags w-50 d-flex gap-2 flex-wrap">
                                    <NavLink className={styles.detailstag} to="/home/books/drama">Drama</NavLink>
                                    <NavLink className={styles.detailstag} to="/home/books/advanture">Advanture</NavLink>
                                    <NavLink className={styles.detailstag} to="/home/books/survival">Survival</NavLink>
                                    <NavLink className={styles.detailstag} to="/home/books/biography">Biography</NavLink>
                                    <NavLink className={styles.detailstag} to="/home/books/brending2020">Trending2020</NavLink>
                                    <NavLink className={styles.detailstag} to="/home/books/bestseller">Bestseller</NavLink>
                                </div>
                            </div>
                        </div>
                    </div>
